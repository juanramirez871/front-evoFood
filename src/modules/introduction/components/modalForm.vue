<template>
    <form action="" class="form_main">
        ...
        <input type="text" class="inputField" id="email" placeholder="E-MAIL">
        </div>
    ...
    <button id="button">INGRESAR</button>
        <a class="forgotLink" href="#">olvidaste tu contraseña?</a>
    </form>
</template>
<script setup>
...
.form_main {
    ...
    box-shadow: 0px 0px 40px rgba(0, 0, 0, 0.265);
    position: relative;
    overflow: hidden;
    border-radius: 10px;
  }
  ...
  .inputField:focus {
    outline: none;
    border-bottom: 2px solid #afc7f4;
  }
