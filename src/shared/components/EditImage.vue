          ...
          <div class="modal-content">
            <VuePictureCropper
              ...
              :options="{
                viewMode: 1,
                dragMode: 'move',
                aspectRatio: props.aspectRatio[1] ? props.aspectRatio[0] / props.aspectRatio[1] : props.aspectRatio[0],
                cropBoxResizable: false,
              }"
              :presetMode="props.presentMode"
            />
          </div>
        </div>
      </div>
...
async function getResult() {
  ...
  emit('uploadImage', { base64, blob, file, url: URL.createObjectURL(blob) })
}
</script>
